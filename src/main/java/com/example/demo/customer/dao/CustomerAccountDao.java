...
/**
 * com.example.demo.customer.dao CustomerAccountDao
 *
...
public interface CustomerAccountDao {
	...
	@Results({ @Result(property = "customerId", column = "customer_id", id = true),
			...
			@Result(property = "billTo", column = "customer_id", many = @Many(select = "com.example.demo.customer.dao.CustomerSiteDao.findAllBillTo", fetchType = FetchType.LAZY) ),
			@Result(property = "shipTo", column = "customer_id", many = @Many(select = "com.example.demo.customer.dao.CustomerSiteDao.findAllShipTo", fetchType = FetchType.LAZY) ),
			@Result(property = "deliverTo", column = "customer_id", many = @Many(select = "com.example.demo.customer.dao.CustomerSiteDao.findAllDeliverTo", fetchType = FetchType.LAZY) ) })
